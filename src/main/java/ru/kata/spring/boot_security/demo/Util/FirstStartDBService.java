...
public class FirstStartDBService implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        User user1 = new User("admin", "I'm", "admin@mail.ru", "admin", roleAdmin);
        User user2 = new User("user", "Very", "user@mail.ru", "user", roleUser);
        User user3 = new User("monster", "Tired", "monster@mail.ru", "monster", roleUserAdmin);
